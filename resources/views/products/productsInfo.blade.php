    ...
    @foreach($products as $key => $product)
        <tr id="{{ $product->id }}">
            ...
            <td style="padding-left: 10px;">
                <select style="color: blue;" class="form-control assigned_to" id="{{ $product->id }}"
                        name="assigned_to">
            ...
            <td style="padding-left: 10px;">
                {!! empty($product->production_date_week) ?
                    '<input type="date" id="'. $product->id .'" name="production_date" class="form-control production_date" value="'. $product->production_date .'">'  :
                    '<input type="week" id="'. $product->id .'" name="production_date_week" class="form-control production_date" value="'. $product->production_date_week .'">' !!}
            </td>
            <td>
