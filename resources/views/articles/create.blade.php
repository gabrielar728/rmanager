                ...
                <section class="panel panel-default">
                    <header class="panel-heading">
                        ...
                        <button type="button" class="btn btn-warning pull-right"
                                ...
                                id="add-more-process"
                                data-target="process-show"><i class="fa fa-plus"></i>ADAUGA PROCES
                        </button>
                    </header>
                    <div class="panel-body">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="input-group" style="margin-bottom: 15px;">
                                ...
                                <div class="input-group-addon">
                                        <span class="fa fa-plus" id="add-more-category"
                                              data-target="#article-category-show" title="Adauga categorie"></span>
                                </div>
                            ...
                            {{--<div class="col-lg-1">
                                ...
                                <div class="form-group">
                                    <input type="number" class="form-control" name="workers_required"
                                           id="workers_required" min="1" required>
                                </div>
                            </div>--}}
                            ...
                            <div class="input-group" style="margin-bottom: 15px;">
                                ...
                                <div class="input-group-addon">
                                        <span class="fa fa-plus" id="add-more-client" data-target="client-show"
                                              title="Adauga client"></span>
                                </div>
                                <div class="input-group-addon" id="del">
                                    <input type="button" id="btnDeleteClient" class="btnDelete"
                                           value="&times;" title="Sterge client"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8">
                            <table class="table table-bordered" style="margin-top: 3%;">
                                <thead>
                                <tr>
                                    <th style="width: 30%; padding-left: 4%; text-align: center;" colspan="6">
                                        <strong style="color: black;">Optiuni cantitati pentru turnare</strong></th>
                                </tr>
                                <tr>
                                    ...
                                    <th style="width:7%;text-align: center; background: #eee;"><a href="#" class="addRow" id="plusRow"><span class="fa fa-plus" title="Adauga optiune"></span></a></th>
                                </tr>
                                </thead>
                                <tbody id="reqStages">
                                <tr>
                                    <td>
                                        ...
                                        <select class="form-control material" id="material" name="material[]"
                                    ...
                                    <td><input type="number" min="0.1" step="0.1" name="quantity[]"
                                               class="form-control quantity" required></td>
                                    <td>
                                        <select class="form-control process_id" name="process_id[]" id="process_id"
                                                required>
                                    ...
                                    <td>
                                        <input class="form-control unit" type="text" name="unit[]" value=""
                                               style="border: none; padding-top: 0; padding-bottom: 0; height: 20px; background-color: transparent;"
                                               readonly></td>
                                    <td style="text-align: center;"><a href="#" class="remove" style="font-size:20px; color: red; text-decoration:none;" title="Sterge optiune"><strong>&times;</strong></a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            {{--<table class="table table-bordered">
                                ...
                                <tr>
                                    <th style="width: 30%; padding-left: 4%; text-align: center;" colspan="6">
                                        <strong style="color: black;">Etape optionale</strong></th>
                                </tr>
                                <tr>
                                    <th style="width: 30%; padding-left: 4%;">Material</th>
                                    <th style="width: 15%;">Cantitate</th>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group" style="float: right;">
                                ...
                                {{ Form::button('<i class="fa fa-floppy-o"></i> Salveaza', ['type' => 'submit', 'class' => 'btn btn-success', 'id' => 'submitFrm'] )  }}
                            </div>
                        </div>
                    </div>
                </section>
...
<style>
    #add-more-category:hover {
        color: #0055b3;
    }

    #add-more-client:hover {
        color: #0055b3;
    }
